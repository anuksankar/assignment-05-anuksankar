...
- In this assignment, you'll spin up a cluster with kafka and zookeeper. This week we're publishing and consuming messages with kafka. 
...
#### Use this command:
    ...
    cat ~/w205/assessment-attempts-20180128-121051-nested.json | jq '.[]' -c | kafkacat -P -b localhost:29092 -t foo && echo 'Produced 100 messages.'
